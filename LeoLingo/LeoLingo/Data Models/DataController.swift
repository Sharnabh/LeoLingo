...
class DataController {
    ...
    private var user: [UserData] = [UserData(name: "Joy", phoneNumber: "1234567890", password: "12345", passcode: "1234", userLevels: [
        Level(levelTitle: "Level 1", levelImage: "1", words: [
            Word(wordTitle: "A", wordImage: "a", record: Record(attempts: 3, accuracy: [70, 60, 90]), isPracticed: true),
            Word(wordTitle: "Alarm", wordImage: "alarm", record: Record(attempts: 3, accuracy: [80, 70, 100]), isPracticed: true),
            Word(wordTitle: "Army", wordImage: "army", record: Record(attempts: 3, accuracy: [70, 75, 85]), isPracticed: true),
            Word(wordTitle: "Art", wordImage: "art", record: Record(attempts: 3, accuracy: [84, 82, 93]), isPracticed: true),
            Word(wordTitle: "Apple", wordImage: "apple", record: Record(attempts: 3, accuracy: [89, 79, 70]), isPracticed: true),
            Word(wordTitle: "Ant", wordImage: "ant", record: Record(attempts: 3, accuracy: [50, 90, 99]), isPracticed: true)
            ]),
        Level(levelTitle: "Level 2", levelImage: "2", words: [
            Word(wordTitle: "B", wordImage: "b", record: Record(attempts: 3, accuracy: [65, 35, 67]), isPracticed: true),
            Word(wordTitle: "Black", wordImage: "black", record: Record(attempts: 3, accuracy: [66, 45, 34]), isPracticed: true),
    ...
    ], userBadges: BadgesDataController.shared.getBadges())]
