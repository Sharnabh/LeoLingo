...
//import UIKit
//
//class WordReportViewController2: UIViewController, UIPopoverPresentationControllerDelegate {
//
//
...
//    @IBOutlet var isPracticedSwitch: UISwitch!
//    @IBOutlet var accuracySortButton: UIButton!
//    
//    let allWords: [Word] = [
...
//    }
//
//    @IBAction func completedSwitchToggled(_ sender: UISwitch) {
//        switch sender.isOn {
//        case true:
//            isFiltered = true
//            filteredWords = allWords.filter {$0.isPassed}
//        case false:
//            isFiltered = false
//            filteredWords = allWords
//        }
//        
//        UIView.transition(with: reportCollectionView, duration: 0.3, options: .transitionCrossDissolve, animations: {
//            self.reportCollectionView.reloadData()
//        })
//    }
//    @IBAction func practicedSwitchToggled(_ sender: UISwitch) {
//        switch sender.isOn {
//        case true:
//            isFiltered = true
//            filteredWords = allWords.filter {$0.isPracticed}
//        case false:
//            isFiltered = false
//            filteredWords = allWords
//        }
...
//            filteredWords.sort {$0.avgAccuracy < $1.avgAccuracy}
//        } else {
//            isFiltered = true
